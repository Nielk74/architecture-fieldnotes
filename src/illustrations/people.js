...
export const peopleDescriptions={
 ...
 agent:'An automated agent with a reasoning loop and tool arm',
...
export function peopleGeometry(kind,p){
 ...
 if(kind==='agent')return `<path d="M0-36v-13" stroke-width="3"/><circle class="role-signal" cy="-51" r="5" fill="${front}"/><rect x="-31" y="-35" width="62" height="44" rx="13" fill="${paper}"/><rect x="-23" y="-26" width="46" height="24" rx="7" fill="${ink}"/><path class="role-cursor" d="M-12-18v8m24-8v8" stroke="${paper}" stroke-width="4"/><path d="M-23 15h46v29h-46Z" fill="${front}"/><path class="people-gesture" d="m23 25 15-14 10 6" fill="none" stroke-width="5"/><g class="people-loop"><path d="M-9 31a10 10 0 1 1 17 5m0-7v8H0" fill="none" stroke="${ink}" stroke-width="2"/></g><path d="M-14 44v12m28-12v12" stroke-width="6"/>`;
