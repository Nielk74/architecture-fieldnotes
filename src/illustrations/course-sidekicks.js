...
const themes={
 'green-software':{color:'#21ceb7',dark:'#00605d',accent:'#ffc52e',shape:'round',stages:[['Resource observer','leaf'],['Energy explorer','battery'],['Waste finder','lens'],['Efficiency builder','wrench'],['Carbon scheduler','clock'],['Hardware caretaker','sprout'],['Footprint measurer','gauge'],['GreenOps guide','checklist'],['Change cultivator','tree'],['Green software steward','garden']]},
 fundamentals:{color:'#21ceb7',dark:'#00605d',accent:'#ffc52e',shape:'square',stages:[['Sketch','pencil'],['Blueprint','blueprint'],['Model maker','blocks'],['Structure builder','ruler'],['Style explorer','compass'],['Quality keeper','diamond'],['Boundary designer','gate'],['Decision author','scroll'],['System composer','city'],['Foundation master','temple']]},
 'hard-parts':{color:'#d8c2fc',dark:'#6425d0',accent:'#ffc52e',shape:'hex',stages:[['Boundary scout','gate'],['Service splitter','scissors'],['Coupling untangler','knot'],['Contract keeper','handshake'],['Data navigator','database'],['Trade-off balancer','balance'],['Workflow conductor','route'],['Saga coordinator','loop'],['Resilience weaver','bridge'],['Distributed master','network']]},
 'staff-engineer':{color:'#ffc52e',dark:'#b87900',accent:'#ff7690',shape:'round',stages:[['Thoughtful listener','ear'],['Context gatherer','notebook'],['Trust builder','heart'],['Direction finder','compass'],['Clear communicator','chat'],['Project guide','flag'],['Team connector','handshake'],['Growth mentor','sprout'],['Influence multiplier','people'],['Staff pathfinder','beacon']]},
 'responsible-engineering':{color:'#21ceb7',dark:'#008579',accent:'#ffc52e',shape:'leaf',stages:[['Impact observer','eye'],['Context explorer','globe'],['Stakeholder listener','people'],['Privacy guardian','lock'],['Fairness advocate','balance'],['Safety steward','shield'],['Planet caretaker','leaf'],['Accountability keeper','scroll'],['Trust cultivator','tree'],['Responsible builder','garden']]},
 sre:{color:'#bce3ff',dark:'#0875df',accent:'#ffc52e',shape:'visor',stages:[['On-call learner','bell'],['Signal watcher','pulse'],['Toil reducer','wrench'],['Service-level keeper','gauge'],['Capacity planner','battery'],['Load navigator','valve'],['Incident responder','radio'],['Recovery captain','lifebuoy'],['Reliability designer','bridge'],['Production guardian','lighthouse']]},
 observability:{color:'#ff7690',dark:'#d3355a',accent:'#21ceb7',shape:'lens',stages:[['Curious observer','lens'],['Event collector','notebook'],['Context explorer','tags'],['Trace follower','route'],['Query explorer','search'],['Hypothesis maker','flask'],['Sampling strategist','funnel'],['Signal interpreter','prism'],['Evidence connector','network'],['Production detective','telescope']]},
 'ai-agents':{color:'#d8c2fc',dark:'#6425d0',accent:'#21ceb7',shape:'antenna',stages:[['Agent apprentice','chip'],['Tool user','wrench'],['Memory keeper','database'],['Planner','steps'],['Retrieval explorer','search'],['Team orchestrator','network'],['Evaluation pilot','checklist'],['Safety navigator','shield'],['Human collaborator','handshake'],['Agent systems master','satellite']]},
};
