...
function showFailure(){if(document.querySelector('#storage-failure'))return;const message=document.createElement('div');message.id='storage-failure';message.setAttribute('role','alert');message.textContent='Progress could not be saved. Keep this screen open and export a backup from the home page.';message.style.cssText='position:fixed;bottom:0;left:0;right:0;padding:16px;background:#fff2c2;color:#922040;z-index:9999';document.body.append(message)}
