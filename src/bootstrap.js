...
boot().catch(()=>{document.querySelector('#app,#studio').innerHTML='<main style="padding:30px;font-family:sans-serif"><h1>Your progress could not be loaded.</h1><p>Close and reopen Fieldnotes to retry. Your saved data has not been reset.</p><button onclick="location.reload()">Retry</button></main>'});
