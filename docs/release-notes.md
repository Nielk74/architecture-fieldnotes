v0.6.1 refreshes Fieldnotes with clearer colors, richer course worlds, and more expressive lesson illustrations.
...
- Android release verification frees build memory before starting its emulator and bounds diagnostic commands when a device disconnects.
